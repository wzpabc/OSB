...
<link rel="stylesheet" type="text/css"
	href="${staticPath }/static/style/css/icons-view.css?v=60" />
<script type="text/javascript"
	src="${staticPath }/static/clipboard/clipboard.min.js" charset="utf-8"></script>
<div class="container">
	<div class="interchange-body">
		<div id="clipIcon" class="large-12 columns">
			<h2 class="with-download-link">图标颜色</h2>
			<ul class="small-block-grid-2 large-block-grid-4">
				<li class="fi-default" style="font-size: 12px;"><input
					type="radio" name="icon" checked> 默认</li>
				<li class="icon-blue"><input type="radio" name="icon"
					value="icon-blue"> 蓝色</li>
				<li class="icon-purple"><input type="radio" name="icon"
					value="icon-purple"> 紫色</li>
				<li class="icon-green"><input type="radio" name="icon"
					value="icon-green"> 绿色</li>
				<li class="icon-red"><input type="radio" name="icon"
					value="icon-red"> 红色</li>
				<li class="icon-yellow"><input type="radio" name="icon"
					value="icon-yellow"> 黄色</li>
				<li class="icon-gray"><input type="radio" name="icon"
					value="icon-gray"> 灰色</li>
				<li class="icon-black"><input type="radio" name="icon"
					value="icon-black"> 黑色</li>
			</ul>
