...
<script type="text/javascript">
    $(function() {
        $('#reportsByTimeEditForm').form({
            url : '${path}/reportsByTime/edit',
            onSubmit : function() {
                progressLoad();
        ...
        $("#editStatus").val('${reportsByTime.status}'); 
        
    });
</script>
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="reportsByTimeEditForm" method="post">
            <table class="grid">
              		         <tr>
                    <td>pk</td>
                    ...
                    <td><input name="p_dm" type="text" class="easyui-textbox"  data-options="required:true" value=""></td>
		                    ...
		                    <tr>
                    <td>商家名称</td>
                    <td><input name="id" type="hidden"  value="${reportsByTime.id}">
                    <input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox" data-options="required:true" value="${reportsByTime.name}"></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
