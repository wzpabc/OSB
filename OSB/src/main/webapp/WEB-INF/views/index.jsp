...
<body>
    ...
    <div id="index_layout">
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by <a href="#" target="_blank">tupperware IT</a></div>
    </div>
    <div id="tabsMenu">
