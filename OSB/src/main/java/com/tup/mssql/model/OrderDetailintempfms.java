...
public class OrderDetailintempfms {
    private String id;
    ...
    public String getFormalDataOpt() {
        return formalDataOpt;
    }

    public void setFormalDataOpt(String formalDataOpt) {
        this.formalDataOpt = formalDataOpt == null ? null : formalDataOpt.trim();
    }
}