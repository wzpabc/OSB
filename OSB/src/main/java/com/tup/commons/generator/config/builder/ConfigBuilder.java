...
import com.tup.commons.generator.config.ConstVal;
...
import com.tup.commons.generator.config.po.TableField;
import com.tup.commons.generator.config.po.TableInfo;
import com.tup.commons.generator.config.rules.DbType;
import com.tup.commons.generator.config.rules.NamingStrategy;
import com.tup.commons.generator.config.rules.QuerySQL;
...
public class ConfigBuilder {
	...
	private void handlerPackage(String outputDir, PackageConfig config) {
		...
		packageInfo.put(ConstVal.FORM, joinPackage(config.getParent(), config.getForm()));	
	...
	private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, String tablePrefix) {
		for (TableInfo tableInfo : tableList) {
			...
			if(StringUtils.isNotEmpty(globalConfig.getFormName())){
				...
				tableInfo.setFormName(tableInfo.getEntityName() + ConstVal.FORM);
			}
			tableInfo.setFormName(toLowerCaseFirstOne(tableInfo.getFormName()));
